...
public class Users extends TableImpl<UsersRecord> {
     ...
     */
    public final TableField<UsersRecord, String> FULL_NAME = createField(DSL.name("full_name"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.users.role</code>.
     */
    public final TableField<UsersRecord, String> ROLE = createField(DSL.name("role"), SQLDataType.VARCHAR(20).nullable(false).defaultValue(DSL.field(DSL.raw("'SHIPPER'::character varying"), SQLDataType.VARCHAR)), this, "");
    ...
    public ShipmentsPath shipments() {
        if (_shipments == null)
            _shipments = new ShipmentsPath(this, null, Keys.SHIPMENTS__FK_SHIPMENTS_SHIPPER.getInverseKey());
    ...
    public List<Check<UsersRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("chk_user_role"), "(((role)::text = ANY ((ARRAY['SHIPPER'::character varying, 'MANAGER'::character varying, 'ADMIN'::character varying])::text[])))", true)
        );
    }
